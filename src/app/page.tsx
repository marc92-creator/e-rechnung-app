...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 print:bg-white print:min-h-0">
      ...
      {/* Main Content */}
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-32 lg:pb-8 print:p-0 print:max-w-none print:mx-0">
        {/* Status Card */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
      ...
      {/* Desktop Footer */}
      <footer className="hidden lg:block bg-white/50 backdrop-blur border-t border-slate-200/50 mt-8 print:hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-sm text-slate-500">E-Rechnung Handwerk · XRechnung 3.0 konform nach EN 16931</p>
            <div className="flex items-center gap-2 text-sm text-slate-500">
              <Shield className="w-4 h-4" />
              100% lokal · Auto-Save · Keine Cloud
            </div>
          </div>
        </div>
      </footer>
